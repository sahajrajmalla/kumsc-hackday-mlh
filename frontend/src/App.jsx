  ...
  return (
    <div className="app-container">
      ...
      <aside className="sidebar">
        <h1>Setu AI <Network size={28} style={{ display: 'inline', verticalAlign: 'middle', marginLeft: '8px' }} /></h1>
        <p className="subtitle">Intelligent route optimization across challenging terrains.</p>
        ...
        {results && (
          <div className="results-container">
            ...
            {results.image && typeof results.image === 'string' && results.image.length > 10 && (
              <div>
